                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="iterations"><g:message code="project.iterations.label" default="Iterations" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: projectInstance, field: 'iterations', 'errors')}">
                                    
<ul>
<g:each in="${projectInstance?.iterations?}" var="i">
    <li><g:link controller="iteration" action="show" id="${i.id}">${i?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="iteration" action="create" params="['project.id': projectInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'iteration.label', default: 'Iteration')])}</g:link>
